        ...
        if webserviceHeaderResponse['Status'] == 'Success':
          ...
          if payloadResponse.get('Status') != None:
            ...
            if payloadResponse['Status'] == 'Success':
              ...
              # Update tv feed
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MariaDBSQLTV', 'updating', 'insertupdatedeletemediafeed', 'updateTVFeed', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('PGSQLTV', 'updating', 'insertupdatedeletemediafeed', 'updateTVFeed', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLLTV', 'updating', 'dbo.insertupdatedeleteMediaFeed', 'updateTVFeed', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLWTV', 'updating', 'dbo.insertupdatedeleteMediaFeed', 'updateTVFeed', possibleParams, payloadResponse['Result'], removeParams)
        ...
        if webserviceHeaderResponse['Status'] == 'Success':
          ...
          if payloadResponse.get('Status') != None:
            ...
            if payloadResponse['Status'] == 'Success':
              ...
              # Delete tv feed
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MariaDBSQLTV', 'deleting', 'insertupdatedeletemediafeed', 'deleteTVFeed', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('PGSQLTV', 'deleting', 'insertupdatedeletemediafeed', 'deleteTVFeed', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLLTV', 'deleting', 'insertupdatedeletemediafeed', 'deleteTVFeed', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLWTV', 'deleting', 'dbo.insertupdatedeleteMediaFeed', 'deleteTVFeed', possibleParams, payloadResponse['Result'], removeParams)
