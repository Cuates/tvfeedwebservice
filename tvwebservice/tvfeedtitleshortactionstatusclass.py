        ...
        if webserviceHeaderResponse['Status'] == 'Success':
          ...
          if payloadResponse.get('Status') != None:
            ...
            if payloadResponse['Status'] == 'Success':
              ...
              # Update tv feed
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MariaDBSQLTV', 'updating', 'insertupdatedeletemediafeed', 'updateTVFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('PGSQLTV', 'updating', 'insertupdatedeletemediafeed', 'updateTVFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLLTV', 'updating', 'dbo.insertupdatedeleteMediaFeed', 'updateTVFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLWTV', 'updating', 'dbo.insertupdatedeleteMediaFeed', 'updateTVFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
        ...
        if webserviceHeaderResponse['Status'] == 'Success':
          ...
          if payloadResponse.get('Status') != None:
            ...
            if payloadResponse['Status'] == 'Success':
              ...
              # Delete tv feed
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MariaDBSQLTV', 'deleting', 'insertupdatedeletemediafeed', 'updateTVFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('PGSQLTV', 'deleting', 'insertupdatedeletemediafeed', 'updateTVFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLLTV', 'deleting', 'dbo.insertupdatedeleteMediaFeed', 'updateTVFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = tfwsclass._insertupdatedeleteTVFeed('MSSQLWTV', 'deleting', 'dbo.insertupdatedeleteMediaFeed', 'updateTVFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
